...
export default function OpenMentoringForm() {
  ...
  return (
    <form action={formAction} className="w-full p-5">
      <div className="w-3/4 flex items-center justify-between mb-4 gap-4">
        <div className="w-1/3">
      ...
      <div className="flex justify-between items-center mb-6 w-3/4 gap-4">
        <div className="w-1/3">
          <Input
            label="날짜"
            type="date"
      ...
      <div className="flex flex-wrap mt-2">
        {tagList.map((item, index) => (
          <div key={index} className="flex items-center">
            <Badge
              text={`#${item}`}
              className="border border-ourOrange text-sm rounded-full "
            />
            <Button
              type="button"
              text="x"
      ...
      <div className="flex flex-col items-center rounded-2xl border border-gray-400 w-[400px] p-4 my-4">
        <div className="relative mb-2 w-[350px] h-[280px]">
          {image ? (
            <Image
